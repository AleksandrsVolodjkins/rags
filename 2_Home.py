...
st.title("")
st.info(
    "Izveidojiet savu AI palīga robotu, izmantojot savus datus! "
    "Kad aģenta izveide ir pabeigta, pārbaudiet,`RAG Config` un "
    "`Generated RAG Agent`.\n"
    #"To build a new agent, please make sure that 'Create a new agent' is selected.",
    "Lai izveidotu jaunu aģentu, lūdzu, pārliecinieties, vai ir atlasīta opcija 'Izveidot jaunu aģentu.'",
    icon="ℹ️",
)
...
if "messages" not in st.session_state.keys():  # Initialize the chat messages history
    st.session_state.messages = [
        {"role": "assistant", "content": "Kādu AI assistentu vēlaties izveidot?"}
    ]
